...
const gmail = config_1.default.get("gmail");
class Email {
    constructor(user, url) {
        ...
        __classPrivateFieldSet(this, _Email_from, gmail.googleSenderMail, "f");
    }
    newTransport() {
    ...
    send(template, subject) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error("📨 To:", __classPrivateFieldGet(this, _Email_to, "f"));
